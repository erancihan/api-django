...
class GreeterStub(object):
    ...
    def __init__(self, channel):
        ...
        """
        self.SayHelloTo = channel.unary_unary(
                '/Greeter/SayHelloTo',
...
def add_GreeterServicer_to_server(servicer, server):
    rpc_method_handlers = {
            'SayHelloTo': grpc.unary_unary_rpc_method_handler(
                    servicer.SayHelloTo,
...
class Greeter(object):
    ...
    def SayHelloTo(request,
            ...
            timeout=None,
            metadata=None):
        return grpc.experimental.unary_unary(request, target, '/Greeter/SayHelloTo',
